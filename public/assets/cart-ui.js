...
(function (global) {
  ...
  function cartPanelInnerHtml(opts) {
    ...
    return (
      ...
      '<div class="lp-cart-pay-section" id="lpCartPaySection">' +
      '<h3 class="lp-cart-pay-section__title">وسيلة الدفع</h3>' +
      '<div id="lpCartPayIcons" class="erv-pay-cards" role="group" aria-label="وسائل الدفع"></div>' +
