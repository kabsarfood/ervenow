#!/usr/bin/env node
/**
 * يولّد docs/MEMBERSHIP-IDENTITY-REPORT.md
 */
const fs = require("fs");
const path = require("path");

const outPath = path.join(__dirname, "..", "docs", "MEMBERSHIP-IDENTITY-REPORT.md");
const generatedAt = new Date().toISOString();

const body = `# ERVENOW — تقرير اعتماد هوية العضوية
