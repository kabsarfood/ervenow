...
(function (global) {
  ...
  var BANNER_CSS =
    ".erv-prereg-banner{display:flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:0.38rem 0.5rem;margin:0;padding:0.55rem max(0.75rem,env(safe-area-inset-left,0px)) 0.55rem max(0.75rem,env(safe-area-inset-right,0px));background:#146c43;color:#f4faf7;line-height:1.5;font-size:0.82rem;text-align:center;position:relative;z-index:90;flex-shrink:0;font-family:Tajawal,Cairo,system-ui,sans-serif;}" +
    ".erv-prereg-banner p{margin:0;flex:0 1 auto;text-align:center;max-width:42rem;}" +
    ".erv-prereg-banner__cta{display:inline-flex;align-items:center;justify-content:center;min-height:40px;padding:0.35rem 0.9rem;border-radius:999px;background:#ffffff;color:#0f5a37;font-weight:800;font-size:0.78rem;text-decoration:none;white-space:nowrap;flex:0 0 auto;box-shadow:0 1px 4px rgba(15,40,28,0.12);}" +
